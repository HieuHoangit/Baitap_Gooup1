...
export { tags, emojis as misc };

export function promotionPercentCalc(price, promotionPrice) {
  const promotionPercent = ((price - promotionPrice) / price) * 100;
  return Math.round(promotionPercent * 100) / 100;
}
...
// Export mặc định danh sách khách sạn
